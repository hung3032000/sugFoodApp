...
const mockRestaurants: Restaurant[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1600470944938-b301e41001c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwZm9vZCUyMGFzaWFufGVufDF8fHx8MTc2NTUyNDk3Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 42,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1666307551772-943e4b88d564?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXhpY2FuJTIwdGFjb3MlMjByZXN0YXVyYW50fGVufDF8fHx8MTc2NTQyODYzOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 56,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1628169822580-ca53b886cdc9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpdGFsaWFuJTIwcGFzdGElMjBwaXp6YXxlbnwxfHx8fDE3NjU0MzQ3OTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 31,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1699874371811-5484a9970441?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXJnZXIlMjBhbWVyaWNhbiUyMGZvb2R8ZW58MXx8fHwxNzY1NDI4NjM5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 48,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1578657084274-03b9d153b0dc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGh5JTIwc2FsYWQlMjBib3dsfGVufDF8fHx8MTc2NTQ3NzI0OXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 29,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1648470820025-f014bc01f9f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHJlZXQlMjBmb29kJTIwdmVuZG9yfGVufDF8fHx8MTc2NTUxOTk0Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    pickCount: 67,
  ...
  const handleAISubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (
        ...
        recommendations = mockRestaurants.filter(
          (r) => r.cuisine === "American" || r.cuisine === "Italian"
        );
        responseText =
          "🍕 Here's some comfort food for when you're feeling down!";
        contextReason =
      ...
      // Stress-based
        ...
        contextReason =
          "Close, affordable spots so you can eat quickly and get back to relaxing.";
      }
      ...
      // Weather - Raining
        ...
        recommendations = mockRestaurants.filter(
          (r) => r.cuisine === "Asian Fusion" || r.cuisine === "Vietnamese"
        );
        responseText = "🌧️ Perfect warm meals for rainy weather!";
        contextReason =
          "Hot soups and Asian comfort food are ideal for rainy days.";
      }
      // Healthy options
      else if (
        ...
        contextReason =
          "Light, nutritious meals to keep you energized and feeling great.";
      }
      // Budget / Cheap
      else if (
      ...
      // Date night / romantic
        ...
        responseText =
          "👩‍❤️‍👨 Romantic dining spots perfect for a special evening!";
        contextReason =
          "Ambiance and quality cuisine for an unforgettable date.";
      }
      // Group gathering
      else if (
        lowerMsg.includes("group") ||
        lowerMsg.includes("friends") ||
        ...
        contextReason =
          "Shareable portions and lively atmosphere for hanging out.";
      }
      // Quick lunch
      else if (
        lowerMsg.includes("quick") ||
        lowerMsg.includes("fast") ||
        lowerMsg.includes("hurry")
      ) {
        recommendations = mockRestaurants.filter(
        ...
        contextReason =
          "Close locations with speedy service to fit your schedule.";
      }
      // Default
      else {
        recommendations = [
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left flex-1">
                ...
                <p className="text-xs text-neutral-600">
                  Not sure what to eat? Let our AI help you decide based on your
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
              <div>
                ...
                <p className="text-white/90 mb-3 text-sm">
                  Local street food favorites with authentic flavors. Perfect
